...
I’m going to be honest with you. I never got a clear cut “why”. 
...
According to Kirsten Nunez, author of “Fight, Flight, Freeze: What This Response Means,” “The reaction begins in your amygdala, the part of your brain responsible for perceived fear. The amygdala responds by sending signals to the hypothalamus, which stimulates the autonomic nervous system (ANS).[^9]

For the purposes of this post, it will be very important for us to understand how the nervous system and the endocrine system work together.

We experience our lives through our nervous system, and if our nervous system is a highway, our neurons on the cars on that highway.

### Neurons

Different nerves have different functions.
- **Sensory, or afferent, neurons** carry information from sensory receptors.
- **Motor, or efferent, neurons** send information to the muscles and glands.
- **Interneurons** are located primarily in the central nervous system are communicates among other neurons. These neurons allow the brain to use many different sources of information to form a coherent picture or thought from the information being provided.[^10]

So, only when the nervous system deciphers something, can the body react.

I briefly mentioned the spinal cord in my breakdown above. Let’s talk about the brain and spinal cord (or the central nervous system) for a moment. 

The spinal cord is a long, thin, tube-like bundle of nerves and other cells that runs from the brain down the spine (your spine protects your spinal cord, in case you missed that day in biology).[^11] The spinal cord is the central highway for almost all of the information for the body. “Within the spinal cord, ascending tracts of sensory neurons relay sensory information from the sense organs to the brain while descending tracts of motor neurons relay motor commands back to the body.”[^12]

> “When a quicker-than-usual response is required, the spinal cord can do its own processing, bypassing the brain altogether.”[^13]

This is called a reflex. Think of touching a hot stove and pulling your hand away before you realized it was hot. Or, maybe catching your phone without realizing you dropped it.[^14]

### How Do Neurons Actually Send Those Signals Though?

Okay, get this. Right now, it is estimated that the brain contains 85 BILLION neurons.[^15] A primary functional unit of the nervous system, a neuron is a nerve cell.[^16]

Neurons pass signals from one to another. This is how the nervous system works. 

In the following example, the neuron initiating the signal is called the presynaptic neuron.[^17] The receiving neuron is called the postsynaptic neuron.[^18]

Neurons will vary in size and shape, but generally they have two sides. One one side, you’ll find dendrites. This is where neurons receive most of their information. Dendrites contain receptors designed to pick up signals from other neurons. These signals are actually chemicals called neurotransmitters.[^19]

The neurotransmitters, picked up by the neuron’s dendrites, cause electrical changes in the neuron. The soma of the neuron, located in the middle of the dendrites, translates these electrical changes.[^20]

The soma contains the nucleus of the cell. Which, as you might remember from biology class, contains the DNA (genetic material) of the nerve cell. The soma gathers all of the information from the dendrites and puts it together in an area called the axon hillock.[^21] 

If the electrical signal in the axon hillock triggered by the neurotransmitters received by the dendrites is strong enough, the signal is then transferred to the axon. This is where the signal is renamed to “action potential”.[^22]

The action potential is sent down the axon (which is protected in a substance call myelin—think insulation for your nerves). The action potential then reaches the other side of the nerve cell.[^23]
...
The receiving neuron, or the postsynaptic neuron sits close to the the presynaptic neuron. This space is called the synapse.[^26]

Inside the synapse, between the presynaptic neuron and the receptors of the postsynaptic neuron is the synaptic cleft. It is microscopic in width—significantly smaller than a strand of hair.[^27]

So, when the electrical signal, or action potential, excites the presynaptic neuron the vesicles will fuse with the presynaptic membrane, releasing their contents, neurotransmitters.[^28] These neurotransmitters bind to the postsynaptic receptors, causing one of two things: 
...
Something to keep in mind about the sympathetic and the parasympathetic nervous systems is where they originate. 

Meaning, the sympathetic nervous system actually originates in the thoracic and lumbar spinal cord.[^31] Basically in your middle and lower back.  

In the sympathetic nervous system, neurons do not typically travel from the spinal cord directly to their target location. Instead, neurons extend from the spinal cord to clusters of neurons off of the spinal cord (the peripheral nervous system) known as ganglia.[^32]

The cluster correlating to the sympathetic nervous system are call the sympathetic ganglia. There is an exception, however. That exception is the sympathetic neurons that travel to the adrenal medulla (the little triangle-shaped thing superior (on top of) to your kidneys). They do not cluster, but instead go directly from the spinal cord to the adrenal medulla.[^33]

The sympathetic nervous system primarily uses norepinephrine as it’s neurotransmitter.[^34]

The parasympathetic nervous system originates in the brain stem and the sacral spinal cord. Basically at the base of your brain and just above your tailbone.[^35]

Like the sympathetic nervous system, neurons do not travel directly from the brainstem or sacral spinal cord. They extend to clusters, also known as ganglia.[^36]

However, for the parasympathetic nervous system these clusters are known as parasympathetic ganglia. 
